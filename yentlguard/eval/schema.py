...
RUNS_SCHEMA = [
    ...
    bigquery.SchemaField(
        "row_id", "STRING", mode="REQUIRED", description="UUID for this row. Primary key."
    ),
    bigquery.SchemaField(
        "created_at",
        "TIMESTAMP",
    ...
    bigquery.SchemaField(
        "candidates_token_count", "INT64", mode="NULLABLE", description="Output generation tokens."
    ),
    bigquery.SchemaField(
        "is_high_friction", "BOOL", mode="NULLABLE", description="True if TAR > 2.0."
    ),
    # ── Correction gate ────────────────────────────────────────────────────
    bigquery.SchemaField(
        "gate_fired",
    ...
    bigquery.SchemaField(
        "esi_pass3a", "STRING", mode="NULLABLE", description="ESI digit predicted by Pass 3a."
    ),
    bigquery.SchemaField(
        "crr_distractor_a",
        "FLOAT64",
    ...
    bigquery.SchemaField(
        "esi_pass3b", "STRING", mode="NULLABLE", description="ESI digit predicted by Pass 3b."
    ),
    bigquery.SchemaField(
        "crr_distractor_b",
        "FLOAT64",
    ...
    bigquery.SchemaField(
        "esi_pass3c", "STRING", mode="NULLABLE", description="ESI digit predicted by Pass 3c."
    ),
    bigquery.SchemaField(
        "crr_distractor_c",
        "FLOAT64",
...
EXPERIMENTS_SCHEMA = [
    ...
    bigquery.SchemaField(
        "models", "STRING", mode="REPEATED", description="Model versions included in this run."
    ),
    bigquery.SchemaField(
        "thinking_budgets", "STRING", mode="REPEATED", description="Thinking budget tiers used."
    ),
    bigquery.SchemaField(
        "variants", "STRING", mode="REPEATED", description="Demographic variants included."
    ),
    bigquery.SchemaField(
        "vignette_count", "INT64", mode="NULLABLE", description="Total vignettes in this run."
    ),
    bigquery.SchemaField("notes", "STRING", mode="NULLABLE", description="Free-text notes."),
    bigquery.SchemaField(
        "yentlbench_version", "STRING", mode="NULLABLE", description="YentlBench package version."
    ),
    bigquery.SchemaField(
        "yentlguard_version", "STRING", mode="NULLABLE", description="YentlGuard package version."
    ),
]
...
def create_dataset_and_tables(client: bigquery.Client | None = None) -> None:
    ...
    runs_table.clustering_fields = ["model_version", "demographic_variant", "experiment_id"]
    ...
    expts_table.description = "One row per experiment batch. JOIN to runs on experiment_id."
